...
class TestFastEngineStrategies:
    ...
    def test_content(self):
        """Contient les 11 stratégies attendues."""
        ...
        expected = {
            ...
            "grid_multi_tf", "grid_funding", "grid_trend",
        }
...
# Valeurs capturées pré-refactoring (seed=42, n=500, vol=2.0)
_EXPECTED_ENVELOPE_DCA = (50.104055320366605, 29132.169772871173, 18.39509832700621, 44)
_EXPECTED_ENVELOPE_DCA_SHORT = (44.65673106641908, 4856.685171782749, 14.947637133339972, 34)
_EXPECTED_GRID_ATR = (52.07744983133752, 117250242.74212204, 3.985910284439234, 108)
