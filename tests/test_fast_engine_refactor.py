...
class TestFastEngineStrategies:
    ...
    def test_content(self):
        """Contient les 14 stratégies attendues."""
...
# Valeurs capturées post-Sprint 36 (fix double slippage + margin deduction, seed=42, n=500, vol=2.0)
_EXPECTED_ENVELOPE_DCA = (55.80433071375841, 19304.7256115464, 16.592905734452888, 44)
_EXPECTED_ENVELOPE_DCA_SHORT = (47.11572436222188, 3791.5518974746747, 12.054795585340214, 34)
_EXPECTED_GRID_ATR = (57.96382506410127, 3530530.126121127, 4.710144215479391, 108)
